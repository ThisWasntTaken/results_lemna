setwd("/mnt/c/Users/anant/Downloads/PhD/cleaned/scripts/lemna2/")
set.seed(3317)
...
# use a separate training data and testing data
# data <- readMat('./data_bin_train.mat')

# OR testing data is used for fitting and for generating parameters (in Analysis.R)
data <- readMat('./data_bin_test.mat')
